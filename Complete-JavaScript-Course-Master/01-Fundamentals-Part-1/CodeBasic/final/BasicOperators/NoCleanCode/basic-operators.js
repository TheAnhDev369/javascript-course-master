//  Về cơ bản, một toán tử cho phép chúng ta chuyển đổi các giá trị haocjw kết hợp nhiều giá trị và
//  thực sự thực hiện tất cả các loại công việc với các giá trị/
...
//  log ra trên cùng 1 dòng, log nhiều giá trị cùng 1 lúc.
//  Bằng cách sử dụng dấu phẩy để ngăn cách giá trị thứ nhất, sau đó là giá trị thứ 2, và nhiều giá trị hơn nữa thì cũng dùng dấu , .
...
//  Ví dụ 2:
const now = 2112;
//  Sử dụng const mặc định, đó là bởi vì ta không thay đổi bất kỳ biến nào trong số này ở đây hay bất kỳ đâu trong mã của tôi.
...
//  Ngoài ví dụ đầu với phép trừ, ta cũng có thể làm tương tự vưới các loại phép toán khác nhau như:
